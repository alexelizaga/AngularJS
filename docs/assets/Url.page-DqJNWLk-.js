import{r as u}from"./index-B-yxVHM3.js";console.log("[url-page] registrado");u("url-page",(i,{html:o,state:s,scope:r,effect:n})=>{const[l,c]=s("");return r.getId=l,n(()=>{const t=angular.element(document.body).injector();if(!t)return;const d=t.get("$route");return r.$watch(()=>{var e,a;return((a=(e=d.current)==null?void 0:e.params)==null?void 0:a.id)??""},e=>c(e))},[]),o`
    <div>
      <div class="card p-4">
