import{r as l}from"./index-B-yxVHM3.js";console.log("[react-page] registrado");l("react-page",(d,{html:s,state:a,scope:e,effect:r})=>{const[n,c]=a(0,{reRender:!1});return e.getClicks=n,e.increment=()=>c(t=>t+1),e.reset=()=>c(0),r(()=>{const t=e.$watch(n,(i,o)=>{i!==o&&console.log("[react-page] clicks changed →",i)});return()=>{t()}},[]),s`
    <div class="py-4">
